<nav class="navbar navbar-top fixed-top navbar-slim justify-content-between navbar-expand-lg" id="navbarComboSlim" data-navbar-top="combo" data-move-target="#navbarVerticalNav" style="display:none;">
    <div class="navbar-logo">
      ...
      <a class="navbar-brand navbar-brand" href="{{ asset('')}}index.html">CRM <span class="text-body-highlight d-none d-sm-inline">Solutions</span></a>
    </div>
    <div class="collapse navbar-collapse navbar-top-collapse order-1 order-lg-0 justify-content-center" id="navbarTopCollapse">
      <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-cube"></span>Apps</a>
          <ul class="dropdown-menu navbar-dropdown-caret">
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="e-commerce" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/add-product.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add product</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/products.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Products</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/customers.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Customers</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/customer-details.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Customer details</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/orders.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Orders</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/order-details.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Order details</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/admin/refund.html">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="customer" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/homepage.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Homepage</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/product-details.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Product details</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/products-filter.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Products filter</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/cart.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Cart</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/checkout.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Checkout</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/shipping-info.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Shipping info</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/profile.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Profile</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/favourite-stores.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Favourite stores</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/wishlist.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Wishlist</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/order-tracking.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Order tracking</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}apps/e-commerce/landing/invoice.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="project-management" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/create-new.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Create new</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/project-list-view.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Project list view</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/project-card-view.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Project card view</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/project-board-view.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Project board view</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/todo-list.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Todo list</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/project-management/project-details.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="travel-agency" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/travel-agency/landing.html">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="hotel" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="admin" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                      ...
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ asset('')}}apps/travel-agency/hotel/admin/add-property.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add property</div>
                          </a></li>
                        <li><a class="dropdown-item nav-link-disable" href="{{ asset('')}}coming-soon.html">
                            <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add room</div>
                          </a></li>
                        <li><a class="dropdown-item" href="{{ asset('')}}apps/travel-agency/hotel/admin/room-listing.html">
                ...
                <li><a class="dropdown-item nav-link-disable" href="{{ asset('')}}upcoming.html">
            ...
            <li><a class="dropdown-item" href="{{ asset('')}}apps/chat.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="email" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/email/inbox.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Inbox</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/email/email-detail.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Email detail</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/email/compose.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="events" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/events/create-an-event.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Create an event</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/events/event-detail.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="kanban" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/kanban/kanban.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Kanban</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/kanban/boards.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Boards</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/kanban/create-kanban-board.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="social" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}apps/social/profile.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Profile</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}apps/social/settings.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Settings</div>
                  </a></li>
              </ul>
            </li>
            <li><a class="dropdown-item" href="{{ asset('')}}apps/calendar.html">
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-files-landscapes-alt"></span>Pages</a>
          <ul class="dropdown-menu navbar-dropdown-caret">
            <li><a class="dropdown-item" href="{{ asset('')}}pages/starter.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="faq" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}pages/faq/faq-accordion.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Faq accordion</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}pages/faq/faq-tab.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="landing" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}pages/landing/default.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Default</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}pages/landing/alternate.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="errors" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}pages/errors/404.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>404</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}pages/errors/403.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>403</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}pages/errors/500.html">
            ...
            <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="authentication" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="simple" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/sign-in.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/sign-up.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/sign-out.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/forgot-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/reset-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/lock-screen.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/simple/2FA.html">
                ...
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="split" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/sign-in.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/sign-up.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/sign-out.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/forgot-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/reset-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/lock-screen.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/split/2FA.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA</div>
                      </a></li>
                  </ul>
                </li>
                <li class="dropdown"><a class="dropdown-item dropdown-toggle" id="Card" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/sign-in.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign in</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/sign-up.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign up</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/sign-out.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Sign out</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/forgot-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Forgot password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/reset-password.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Reset password</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/lock-screen.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Lock screen</div>
                      </a></li>
                    <li><a class="dropdown-item" href="{{ asset('')}}pages/authentication/card/2FA.html">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>2FA</div>
                      </a></li>
                  </ul>
                </li>
              ...
              <div class="px-3 pt-4 pb-3 img-dropdown">
                <div class="row gx-4 gy-5">
                  <div class="col-12 col-sm-6 col-md-4">
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/form-control.html">Form control</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/input-group.html">Input group</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/select.html">Select</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/checks.html">Checks</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/range.html">Range</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/floating-labels.html">Floating labels</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/basic/layout.html">Layout</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/advance-select.html">Advance select</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/date-picker.html">Date picker</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/editor.html">Editor</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/file-uploader.html">File uploader</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/rating.html">Rating</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/advance/emoji-button.html">Emoji button</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/validation.html">Validation</a><a class="dropdown-link" href="{{ asset('')}}modules/forms/wizard.html">Wizard</a>
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/icons/feather.html">Feather</a><a class="dropdown-link" href="{{ asset('')}}modules/icons/font-awesome.html">Font awesome</a><a class="dropdown-link" href="{{ asset('')}}modules/icons/unicons.html">Unicons</a>
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/echarts/line-charts.html">Line charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/bar-charts.html">Bar charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/candlestick-charts.html">Candlestick charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/geo-map.html">Geo map</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/scatter-charts.html">Scatter charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/pie-charts.html">Pie charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/gauge-chart.html">Gauge chart</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/radar-charts.html">Radar charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/heatmap-charts.html">Heatmap charts</a><a class="dropdown-link" href="{{ asset('')}}modules/echarts/how-to-use.html">How to use</a>
                  </div>
                  <div class="col-12 col-sm-6 col-md-4">
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/components/accordion.html">Accordion</a><a class="dropdown-link" href="{{ asset('')}}modules/components/avatar.html">Avatar</a><a class="dropdown-link" href="{{ asset('')}}modules/components/alerts.html">Alerts</a><a class="dropdown-link" href="{{ asset('')}}modules/components/badge.html">Badge</a><a class="dropdown-link" href="{{ asset('')}}modules/components/breadcrumb.html">Breadcrumb</a><a class="dropdown-link" href="{{ asset('')}}modules/components/button.html">Buttons</a><a class="dropdown-link" href="{{ asset('')}}modules/components/calendar.html">Calendar</a><a class="dropdown-link" href="{{ asset('')}}modules/components/card.html">Card</a><a class="dropdown-link" href="{{ asset('')}}modules/components/carousel/bootstrap.html">Bootstrap</a><a class="dropdown-link" href="{{ asset('')}}modules/components/carousel/swiper.html">Swiper</a><a class="dropdown-link" href="{{ asset('')}}modules/components/collapse.html">Collapse</a><a class="dropdown-link" href="{{ asset('')}}modules/components/dropdown.html">Dropdown</a><a class="dropdown-link" href="{{ asset('')}}modules/components/list-group.html">List group</a><a class="dropdown-link" href="{{ asset('')}}modules/components/modal.html">Modals</a><a class="dropdown-link" href="{{ asset('')}}modules/components/navs-and-tabs/navs.html">Navs</a><a class="dropdown-link" href="{{ asset('')}}modules/components/navs-and-tabs/navbar.html">Navbar</a><a class="dropdown-link" href="{{ asset('')}}modules/components/navs-and-tabs/tabs.html">Tabs</a><a class="dropdown-link" href="{{ asset('')}}modules/components/offcanvas.html">Offcanvas</a><a class="dropdown-link" href="{{ asset('')}}modules/components/progress-bar.html">Progress bar</a><a class="dropdown-link" href="{{ asset('')}}modules/components/placeholder.html">Placeholder</a><a class="dropdown-link" href="{{ asset('')}}modules/components/pagination.html">Pagination</a><a class="dropdown-link" href="{{ asset('')}}modules/components/popovers.html">Popovers</a><a class="dropdown-link" href="{{ asset('')}}modules/components/scrollspy.html">Scrollspy</a><a class="dropdown-link" href="{{ asset('')}}modules/components/sortable.html">Sortable</a><a class="dropdown-link" href="{{ asset('')}}modules/components/spinners.html">Spinners</a><a class="dropdown-link" href="{{ asset('')}}modules/components/toast.html">Toast</a><a class="dropdown-link" href="{{ asset('')}}modules/components/tooltips.html">Tooltips</a><a class="dropdown-link" href="{{ asset('')}}modules/components/chat-widget.html">Chat widget</a>
                  </div>
                  <div class="col-12 col-sm-6 col-md-4">
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/tables/basic-tables.html">Basic tables</a><a class="dropdown-link" href="{{ asset('')}}modules/tables/advance-tables.html">Advance tables</a><a class="dropdown-link" href="{{ asset('')}}modules/tables/bulk-select.html">Bulk Select</a>
                    ...
                    </div><a class="dropdown-link" href="{{ asset('')}}modules/utilities/background.html">Background</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/borders.html">Borders</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/colors.html">Colors</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/display.html">Display</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/flex.html">Flex</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/stacks.html">Stacks</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/float.html">Float</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/grid.html">Grid</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/interactions.html">Interactions</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/opacity.html">Opacity</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/overflow.html">Overflow</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/position.html">Position</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/shadows.html">Shadows</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/sizing.html">Sizing</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/spacing.html">Spacing</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/typography.html">Typography</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/vertical-align.html">Vertical align</a><a class="dropdown-link" href="{{ asset('')}}modules/utilities/visibility.html">Visibility</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <li class="nav-item dropdown"><a class="nav-link dropdown-toggle lh-1" href="#!" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span class="uil fs-8 me-2 uil-document-layout-right"></span>Documentation</a>
          <ul class="dropdown-menu navbar-dropdown-caret">
            <li><a class="dropdown-item" href="{{ asset('')}}documentation/getting-started.html">
            ...
            <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="customization" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/customization/configuration.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Configuration</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/customization/styling.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Styling</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/customization/color.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Color</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/customization/dark-mode.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Dark mode</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/customization/plugin.html">
            ...
            <li class="dropdown dropdown-inside"><a class="dropdown-item dropdown-toggle" id="layouts-doc" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/layouts/vertical-navbar.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Vertical navbar</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/layouts/horizontal-navbar.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Horizontal navbar</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/layouts/combo-navbar.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Combo navbar</div>
                  </a></li>
                <li><a class="dropdown-item" href="{{ asset('')}}documentation/layouts/dual-nav.html">
                    <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Dual nav</div>
                  </a></li>
              </ul>
            </li>
            <li><a class="dropdown-item" href="{{ asset('')}}documentation/gulp.html">
                <div class="dropdown-item-wrapper"><span class="me-2 fa-brands fa-gulp ms-1 me-1 fa-lg"></span>Gulp</div>
              </a></li>
            <li><a class="dropdown-item" href="{{ asset('')}}documentation/design-file.html">
                <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="figma"></span>Design file</div>
              </a></li>
            <li><a class="dropdown-item" href="{{ asset('')}}changelog.html">
                <div class="dropdown-item-wrapper"><span class="me-2 uil" data-feather="git-merge"></span>Changelog</div>
              </a></li>
            <li><a class="dropdown-item" href="{{ asset('')}}showcase.html">
    ...
    <ul class="navbar-nav navbar-nav-icons flex-row">
      ...
      <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0 white-space-nowrap" id="navbarDropdownUser" href="#!" role="button" data-bs-toggle="dropdown" aria-haspopup="true" data-bs-auto-close="outside" aria-expanded="false">{{ Auth::user()->name }} <span class="fa-solid fa-chevron-down fs-10"></span></a>
